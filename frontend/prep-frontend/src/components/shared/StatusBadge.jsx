const config = {
  ...
  RejectedByCapturista: { label: 'Rechazada (capturista)', bg: '#fee2e2', text: '#991b1b', border: '#fca5a5' },
...
export default function StatusBadge({ value, type = 'status' }) {
  ...
  return (
    <span style={{ background: c.bg, color: c.text, border: `1px solid ${c.border}`, maxWidth: 120, whiteSpace: 'normal', textAlign: 'center' }}
